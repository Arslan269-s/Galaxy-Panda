  ...
  <Navbar.Collapse id="responsive-navbar-nav collasible-nav-dropdown" >
    <Nav className="ms-auto">
      ...
      <NavDropdown title="NFT" id="collasible-nav-dropdown">
        <NavDropdown.Item href="rankings.html">Rarity Ranking</NavDropdown.Item>
        <NavDropdown.Item href="attributes.html">Attributes</NavDropdown.Item>
        <NavDropdown.Item href="index.html#section-stats">Mint State</NavDropdown.Item>
         <NavDropdown.Divider />
        </NavDropdown>
