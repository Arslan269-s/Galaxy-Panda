							...
							<div className="pricing-s1 mb30" style={{backgroundColor: "#21273e",}}>
								...
								<div className="bottom">
									<ul style={{textAlign: "center",}}>
										...
										<li style={{color: "#fff",}}><i className="fa fa-check" style={{color: "#7D3DA9",}}></i>3 SOL per NFT</li>
									</ul>
								</div>
								<div className="action">
									<a href="#" className="btn-main pixel-font pr-3"
										style={{fontSize: "24px", padding: "15px 30px", letterSpacing: "2px",}}>Sold Out</a>
								</div>
							</div>
						</div>
					</div>
